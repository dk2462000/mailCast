...
public class MyListener implements ServletContextListener{
	...
	try{
		...
		PreparedStatement ps2= con.prepareStatement("CREATE SEQUENCE DeepSolutions MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE");
		ps2.executeUpdate();
		...
		Statement stmt=con.createStatement();
	        stmt.executeUpdate("CREATE TRIGGER  BI_INBOX6 before insert on INBOX6 for each row begin select DeepSolutions.nextval into :NEW.ID from dual;end");
		}	
